...
```{r}
output_df = map(B_1list, ~rerun(100, sim_regression(B_1 = .x)))
```
...
does not approximate the true value of $\beta_1$. However, it can approximate the true value
